...
public final class ShareCompat
{
    ...
    public static void configureMenuItem(MenuItem menuitem, IntentBuilder intentbuilder)
    {
        ...
        if(!(obj instanceof ShareActionProvider))
            obj = new ShareActionProvider(intentbuilder.getActivity());
        else
            obj = (ShareActionProvider)obj;
        ((ShareActionProvider) (obj)).setShareHistoryFileName((new StringBuilder()).append(".sharecompat_").append(intentbuilder.getActivity().getClass().getName()).toString());
