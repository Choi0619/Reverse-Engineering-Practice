...
public final class NotificationManagerCompat
{
        ...
        implements android.os.Handler.Callback, ServiceConnection
    {
        ...
        private boolean ensureServiceBound(ListenerRecord listenerrecord)
        {
            ...
            listenerrecord.bound = mContext.bindService(intent, this, 33);
            if(listenerrecord.bound)
            {
...
_L6:
        ...
        private void updateListenerMap()
        {
            ...
            if(!((Set) (obj)).equals(mCachedEnabledPackages))
            {
                ...
                Object obj1 = mContext.getPackageManager().queryIntentServices((new Intent()).setAction("android.support.BIND_NOTIFICATION_SIDE_CHANNEL"), 0);
