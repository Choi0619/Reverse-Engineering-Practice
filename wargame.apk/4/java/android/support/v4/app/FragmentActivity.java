    ...
    implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator
{
    ...
    private static void markState(FragmentManager fragmentmanager, android.arch.lifecycle.Lifecycle.State state)
    {
        ...
        do
        {
            if(!fragmentmanager.hasNext())
                break;
            Fragment fragment = (Fragment)fragmentmanager.next();
            if(fragment != null)
            {
...
label0:
    ...
    protected void onSaveInstanceState(Bundle bundle)
    {
        ...
        markState(getSupportFragmentManager(), android.arch.lifecycle.Lifecycle.State.CREATED);
