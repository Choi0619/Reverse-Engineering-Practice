...
_L3:
    ...
    private static void configureTransitionsOrdered(FragmentManagerImpl fragmentmanagerimpl, int i, FragmentContainerTransition fragmentcontainertransition, View view, ArrayMap arraymap)
    {
        ...
        if(viewgroup != null)
        {
            ...
            Object obj1 = configureSharedElementsOrdered(viewgroup, view, arraymap, fragmentcontainertransition, arraylist1, arraylist, obj, fragmentmanagerimpl);
            if(obj != null || obj1 != null || fragmentmanagerimpl != null)
            {
                ...
                if(fragmentcontainertransition != null)
                {
                    ...
                    FragmentTransitionCompat21.setNameOverridesOrdered(viewgroup, arraylist, arraymap);
    ...
    private static void configureTransitionsReordered(FragmentManagerImpl fragmentmanagerimpl, int i, FragmentContainerTransition fragmentcontainertransition, View view, ArrayMap arraymap)
    {
        ...
        if(viewgroup != null)
        {
            ...
            fragmentcontainertransition = ((FragmentContainerTransition) (configureSharedElementsReordered(viewgroup, view, arraymap, fragmentcontainertransition, arraylist, fragmentmanagerimpl, obj, obj1)));
            if(obj != null || fragmentcontainertransition != null || obj1 != null)
            {
                ...
                if(obj3 != null)
                {
                    ...
                    obj2 = FragmentTransitionCompat21.prepareSetNameOverridesReordered(fragmentmanagerimpl);
                    ...
                    FragmentTransitionCompat21.setNameOverridesReordered(viewgroup, arraylist, fragmentmanagerimpl, ((ArrayList) (obj2)), arraymap);
