...
_L3:
    ...
    private void showMenu(MenuBuilder menubuilder)
    {
        ...
        obj1 = menupopupwindow.getListView();
        ((ListView) (obj1)).setOnKeyListener(this);
        if(obj == null && mShowTitle && menubuilder.getHeaderTitle() != null)
        {
            obj = (FrameLayout)((LayoutInflater) (obj2)).inflate(android.support.v7.appcompat.R.layout.abc_popup_menu_header_item_layout, ((android.view.ViewGroup) (obj1)), false);
