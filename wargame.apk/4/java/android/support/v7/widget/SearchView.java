...
;
        ...
        ViewCompat.setBackground(mSearchPlate, attributeset.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(mSubmitArea, attributeset.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_submitBackground));
        ...
        TooltipCompat.setTooltipText(mSearchButton, getResources().getString(android.support.v7.appcompat.R.string.abc_searchview_description_search));
