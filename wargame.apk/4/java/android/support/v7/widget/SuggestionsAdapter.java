...
_L1:
    ...
    {
        if(s != null && !s.isEmpty() && !"0".equals(s)) goto _L2; else goto _L1
_L1:
        Object obj = null;
_L4:
        return ((Drawable) (obj));
...
_L3:
    ...
    public View getDropDownView(int i, View view, ViewGroup viewgroup)
    {
        ...
        catch(RuntimeException runtimeexception)
        {
            ...
            viewgroup = newDropDownView(mContext, mCursor, viewgroup);
            view = viewgroup;
            if(viewgroup != null)
            {
...
_L1:
        return null;
_L2:
        if((charsequence = getSearchManagerSuggestions(mSearchable, charsequence, 50)) == null) goto _L1; else goto _L3
_L3:
        try
        {
