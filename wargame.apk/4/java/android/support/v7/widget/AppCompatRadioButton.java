    ...
    implements TintableCompoundButton
{
    ...
    {
        AppCompatRadioButton(context, attributeset, android.support.v7.appcompat.R.attr.radioButtonStyle);
    }

    public AppCompatRadioButton(Context context, AttributeSet attributeset, int i)
    {
        RadioButton(TintContextWrapper.wrap(context), attributeset, i);
