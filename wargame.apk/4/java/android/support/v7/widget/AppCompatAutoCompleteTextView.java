    ...
    implements TintableBackgroundView
{
    ...
    {
        AppCompatAutoCompleteTextView(context, null);
    }

    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeset)
    {
        AppCompatAutoCompleteTextView(context, attributeset, android.support.v7.appcompat.R.attr.autoCompleteTextViewStyle);
    }

    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeset, int i)
    {
        AutoCompleteTextView(TintContextWrapper.wrap(context), attributeset, i);
