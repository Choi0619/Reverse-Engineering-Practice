    ...
    private static class VPathRenderer
    {
        ...
        private void drawPath(VGroup vgroup, VPath vpath, Canvas canvas, int i, int j, ColorFilter colorfilter)
        {
            ...
            if(f1 != 0.0F)
            {
                ...
                if(vpath.isClipPath())
                {
                    mRenderPath.addPath(vgroup, mFinalPathMatrix);
                ...
                if(((VFullPath) (vpath)).mTrimPathStart != 0.0F || ((VFullPath) (vpath)).mTrimPathEnd != 1.0F)
                {
                    ...
                    if(f6 > f4)
                    {
                        mPathMeasure.getSegment(f6, f3, vgroup, true);
                        mPathMeasure.getSegment(0.0F, f4, vgroup, true);
                    } else
                    {
                        mPathMeasure.getSegment(f6, f4, vgroup, true);
                    }
                ...
                if(((VFullPath) (vpath)).mFillColor != 0)
                {
                    ...
                    if(((VFullPath) (vpath)).mFillRule == 0)
                        vgroup = android.graphics.Path.FillType.WINDING;
                    else
                        vgroup = android.graphics.Path.FillType.EVEN_ODD;
                    path.setFillType(vgroup);
                ...
                if(((VFullPath) (vpath)).mStrokeColor != 0)
                {
                    ...
                    vgroup.setStrokeWidth(((VFullPath) (vpath)).mStrokeWidth * (f * f1));
                    canvas.drawPath(mRenderPath, vgroup);
                    return;
                }
            }
        }
